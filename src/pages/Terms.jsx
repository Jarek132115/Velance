...
export default function Terms() {
  return (
    <>
      <Helmet>
        <title>Terms & Conditions — VELANCE</title>
      </Helmet>
      ...
      <div className="container-md py-12">
        <div className="font-body text-charcoal-200 space-y-6">
          {[
            { title: '1. Agreement', body: 'By using the VELANCE website and purchasing our products, you agree to these terms. VELANCE Ltd is registered in Ireland.' },
            ...
            { title: '5. Returns', body: 'You have 30 days from receipt to return any product in its original, unopened condition. To initiate a return, email returns@velance.eu with your order number. Refunds are processed within 5 business days of receiving your return.' },
