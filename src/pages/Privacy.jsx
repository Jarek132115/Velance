...
export default function Privacy() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy — VELANCE</title>
        <meta name="description" content="VELANCE's privacy policy — how we collect, use, and protect your personal data in compliance with GDPR." />
      </Helmet>
      ...
      <div className="container-md py-12">
        <div className="prose prose-charcoal max-w-none font-body text-charcoal-200 space-y-6">
          {[
            { title: '1. Who we are', body: 'VELANCE Ltd is a company registered in Ireland (Company No. 789456). We operate the website velance.eu and sell premium skincare and wellness products across the European Union. As data controller, we are responsible for your personal data.' },
            ...
            { title: '4. Your rights under GDPR', body: 'You have the right to access your personal data, correct inaccurate data, request deletion of your data, object to processing, request data portability, and withdraw consent at any time. To exercise any of these rights, email us at privacy@velance.eu.' },
            ...
            { title: '7. Contact', body: 'For privacy enquiries, contact our Data Protection Officer at privacy@velance.eu or write to VELANCE Ltd, 1 Grand Canal Square, Dublin 2, Ireland.' },
          ].map(({ title, body }) => (
            <div key={title}>
