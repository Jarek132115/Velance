...
export default function Ingredients() {
  return (
    <>
      <Helmet>
        <title>Our Ingredients — VELANCE Skincare Science</title>
        <meta name="description" content="The clinical evidence behind every VELANCE active ingredient. Bakuchiol, Argireline®, Matrixyl 3000®, Haloxyl™, Eyeliss™, L-Ascorbic Acid and more — explained honestly." />
      </Helmet>
      ...
      <div className="container-xl py-12 md:py-16">
        ...
        <div className="mt-14 bg-sage text-cream rounded-md p-8 md:p-10">
          ...
          <p className="body-base text-sage-100 mb-6">
            Every VELANCE formula is free from synthetic fragrance, parabens, formaldehyde-releasing preservatives, mineral oils, and PEGs. Not because these ingredients are necessarily harmful at the concentrations used in cosmetics — but because they add no benefit, and we will not use an ingredient that does not earn its place in the formula.
          </p>
